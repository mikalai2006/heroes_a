...
public class UIGameAsideView : UIView
{
    ...
    public void Init()
    {
        try
        {
            ...
            btnGoHero.RegisterCallback<ClickEvent>(ChangeHero, TrickleDown.NoTrickleDown);
    ...
    private void ChangeHero(ClickEvent evt)
    {
    ...
    public void OnToogleEnableBtnGoHero()
    {
