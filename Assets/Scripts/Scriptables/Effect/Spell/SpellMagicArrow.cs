...
[CreateAssetMenu(fileName = "SpellMagicArrow", menuName = "Game/Attribute/Spell/7_MagicArrow", order = 7)]
public class SpellMagicArrow : ScriptableAttributeSpell
{
    ...
    public async override UniTask AddEffect(GridArenaNode node, ArenaHeroEntity heroRunSpell, ArenaManager arenaManager, Player player = null)
    {
        ...
        int totalDamage = dataCurrent.Effect + (heroRunSpell.Entity.Data.PSkills[TypePrimarySkill.Power] * 10);
