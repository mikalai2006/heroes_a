...
[CreateAssetMenu(fileName = "SpellFortune", menuName = "Game/Attribute/Spell/21_Fortune", order = 21)]
public class SpellFortune : ScriptableAttributeSpell
{
    ...
    public async override UniTask AddEffect(GridArenaNode node, EntityHero heroRunSpell, ArenaManager arenaManager, Player player = null)
    {
        ...
        if (!creatureArena.Data.LuckyModificators.ContainsKey(this))
        {
            creatureArena.Data.LuckyModificators.Add(this, dataCurrent.Effect);
        }
    ...
    public async override UniTask RemoveEffect(GridArenaNode node, EntityHero hero, Player player = null)
    {
        ...
        entity.Data.LuckyModificators.Remove(this);
