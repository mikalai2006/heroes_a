...
[CreateAssetMenu(fileName = "LightningBolt", menuName = "Game/Attribute/Spell/23_LightningBolt", order = 23)]
public class SpellLightningBolt : ScriptableAttributeSpell
{
    ...
    public async override UniTask AddEffect(GridArenaNode node, ArenaHeroEntity heroRunSpell, ArenaManager arenaManager, Player player = null)
    {
        ...
        int totalDamage = dataCurrent.Effect + (heroRunSpell.Entity.Data.PSkills[TypePrimarySkill.Power] * 25);
