...
[CreateAssetMenu(fileName = "ProtectionFromAir", menuName = "Game/Attribute/Spell/25_ProtectionFromAir", order = 25)]
public class SpellProtectionFromAir : ScriptableAttributeSpell
{
    ...
    public async override UniTask AddEffect(GridArenaNode node, EntityHero heroRunSpell, ArenaManager arenaManager, Player player = null)
    {
        ...
        if (!creatureArena.Data.AirDefenseModificators.ContainsKey(this))
        {
            creatureArena.Data.AirDefenseModificators.Add(this, dataCurrent.Effect);
        }
    ...
    public async override UniTask RemoveEffect(GridArenaNode node, EntityHero hero, Player player = null)
    {
        ...
        entity.Data.AirDefenseModificators.Remove(this);
