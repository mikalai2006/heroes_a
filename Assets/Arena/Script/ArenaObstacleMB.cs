...
public class ArenaObstacleMB : MonoBehaviour
{
    [SerializeField] protected ArenaObstacle _arenaSpellEntity;
    public ArenaObstacle ArenaSpellEntity => _arenaSpellEntity;
    ...
    public void Init(ArenaObstacle entitySpell)
    {
